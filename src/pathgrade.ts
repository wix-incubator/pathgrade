 ...
 *   pathgrade init                Generate <name>.eval.ts from detected skills
...
function printHelp() {
  ...
  Usage:
    ...
    pathgrade init [--force]      Generate <name>.eval.ts (--force to overwrite)
    pathgrade preview [browser]   View results (CLI default, or browser)
  ...
  Examples:
    pathgrade init                # scaffold <name>.eval.ts
