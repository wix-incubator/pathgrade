...
| Staged tarball SHA-512 equals the retained tarball | PENDING | PENDING |

The protected job verifies the downloaded tarball against the retained SHA-512 before staging those exact bytes.
